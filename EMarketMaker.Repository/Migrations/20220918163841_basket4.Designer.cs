...
namespace EMarketMaker.Repository.Migrations
{
    ...
    [Migration("20220918163841_basket4")]
    partial class basket4
    {
            ...
            modelBuilder.Entity("EMarketMaker.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 9, 18, 19, 38, 41, 406, DateTimeKind.Local).AddTicks(8834),
                            Name = "Kalem 1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 9, 18, 19, 38, 41, 406, DateTimeKind.Local).AddTicks(8843),
                            Name = "Kalem 2",
                            Price = 300m,
                            Stock = 40
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 9, 18, 19, 38, 41, 406, DateTimeKind.Local).AddTicks(8845),
                            Name = "Kalem 3",
                            Price = 600m,
                            Stock = 30
                        },
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2022, 9, 18, 19, 38, 41, 406, DateTimeKind.Local).AddTicks(8846),
                            Name = "Kitap 1",
                            Price = 1000m,
                            Stock = 10
                        },
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2022, 9, 18, 19, 38, 41, 406, DateTimeKind.Local).AddTicks(8847),
                            Name = "Kitap 2",
                            Price = 60m,
                            Stock = 10
                        });
