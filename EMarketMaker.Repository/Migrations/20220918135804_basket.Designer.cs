...
namespace EMarketMaker.Repository.Migrations
{
    ...
    [Migration("20220918135804_basket")]
            ...
            modelBuilder.Entity("EMarketMaker.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 9, 18, 16, 58, 4, 40, DateTimeKind.Local).AddTicks(1476),
                            Name = "Kalem 1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 9, 18, 16, 58, 4, 40, DateTimeKind.Local).AddTicks(1487),
                            Name = "Kalem 2",
                            Price = 300m,
                            Stock = 40
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 9, 18, 16, 58, 4, 40, DateTimeKind.Local).AddTicks(1488),
                            Name = "Kalem 3",
                            Price = 600m,
                            Stock = 30
                        },
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2022, 9, 18, 16, 58, 4, 40, DateTimeKind.Local).AddTicks(1489),
                            Name = "Kitap 1",
                            Price = 1000m,
                            Stock = 10
                        },
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2022, 9, 18, 16, 58, 4, 40, DateTimeKind.Local).AddTicks(1490),
                            Name = "Kitap 2",
                            Price = 60m,
                            Stock = 10
                        });
